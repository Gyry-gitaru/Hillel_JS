...
const init = (firstNameLetter, lastNameLetter, gender) => {
    const regEx = /^[a-zA-Z ]+$/; 
    let isRightArgs = regEx.test(firstNameLetter) && regEx.test(lastNameLetter) && regEx.test(gender);

    console.log(typeof firstNameLetter, typeof lastNameLetter, typeof gender);
    console.log(isRightArgs);
    if (!isRightArgs) {
...
const result = init(userName, userSurname, userGender);
